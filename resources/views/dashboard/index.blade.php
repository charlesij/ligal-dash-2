...
@section('container')
	...
	<div class="main-content app-content">
        ...
        @else
				<div>
					<p class="fw-semibold fs-20 mb-0">Welcome, Visitor</p>
			...
			<div class="row">
					<div class="col-xxl-12">
							<div class="row">
													...
													<div class="card-body">
															<div class="d-flex align-items-start justify-content-between mb-3 flex-wrap">
																	<div>
																			...
																			<h3 class="fw-semibold lh-1 mb-0">20,500</h3>
																	</div>
																	<div class="text-end">
																			<div class="mb-4">
                                    ...
                                    <h3 class="fw-semibold lh-1 mb-0">$25,000</h3>
																	</div>
																	<div class="text-end">
																			<div class="mb-4">
													...
													<div class="card-body">
															<div class="d-flex align-items-start justify-content-between mb-3 flex-wrap">
																	<div>
																			...
																			<h3 class="fw-semibold lh-1 mb-0">{{ $visitor->total_visitor }}</h3>
																	</div>
																	<div class="text-end">
																			<div class="mb-4">
