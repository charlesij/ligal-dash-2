                  ...
                  <div class="card custom-card profile-card">
                      <div class="card-body pb-0 position-relative">
                          <div class="profile-banner-img">
                              <img src="{{ asset('/storage').'/user/'.$userDetails->profile_background }}" class="rounded w-100" alt="...">
                          </div>
                          <span class="avatar avatar-xxl avatar-rounded bg-light">
                           
                              <img src="{{ asset('/storage').'/user/'.$userDetails->profile_photo }}" alt="">
                          </span>
                          <div
                              ...
                              <div>
                                  ...
                                  <p class="fs-12 mb-0 fw-medium text-muted"> <span class="me-3">
                                    <i class="ri-building-line me-1 align-middle"></i>{{ $userDetails->city }}</span>
                                      <span><i class="ri-map-pin-line me-1 align-middle"></i>{{ $userDetails->state }}</span>
                                  </p>
                              </div>
                              <div class="d-flex mb-0 flex-wrap gap-4">
                                  <div
                                      ...
                                      <div>
                                          <p class="fw-semibold h6 mb-0">{{ $userDetails->projects }}</p>
                                  ...
                                  <div
                                      ...
                                      <div>
                                          <p class="fw-semibold h6 mb-0">{{ $userDetails->success_rate }}</p>
                                  ...
                                  <div
                                      ...
                                      <div>
                                          <p class="fw-semibold h6 mb-0">{{ $userDetails->earning }}</p>
                          ...
                          <ul class="list-group list-group-flush">
                                <li class="list-group-item p-3 border-top">
                                    <span class="fw-medium fs-15 d-block mb-3">
                                        <span class="me-1"></span>Personal Bio:
                                    </span>
                                    @php
                                        $personalBioLines = explode("\n", $userDetails->personal_bio);
                                    @endphp
                                    @foreach($personalBioLines as $index => $line)
                                        @php
                                            $line = trim($line);
                                        @endphp
                                        @if (!empty($line))
                                            <p class="text-muted {{ $loop->last ? 'mb-0' : 'mb-2' }}">
                                                {{ $line }}
                                            </p>
                                        @endif
                                    @endforeach
                                ...
                                <li class="list-group-item p-3">
                                    ...
                                    <div class="w-75">
                                        @php
                                            $skills = explode(',', $userDetails->skills);
                                        @endphp
                          ...
                          <ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item">
                                  <div><span class="fw-medium me-2">Email :</span><span
                                          class="text-muted">{{ $userData->email }}</span></div>
                              </li>
                              <li class="list-group-item">
                                  <div><span class="fw-medium me-2">Phone :</span><span
                                          class="text-muted">{{ ($userData->phone === null) ? '+62
                                          812 4567 8910' : $userData->phone}}</span></div>
                              </li>
                              <li class="list-group-item">
                                  <div><span class="fw-medium me-2">Designation :</span><span
                                          class="text-muted">{{ $userDetails->profession }}</span></div>
                              </li>
                              <li class="list-group-item">
                                      ...
                                      <li class="list-group-item p-4">
                                          ...
                                          <div class="text-muted">
                                              ...
                                              <p class="mb-2">
                                                  ...
                                                  {{ ($userData->phone === null) ? '+62 812 4567 8910' : $userData->phone}}
                                              </p>
                                              <p class="mb-2">
                                                  <span
                                                      class="avatar avatar-sm avatar-rounded text-muted">
