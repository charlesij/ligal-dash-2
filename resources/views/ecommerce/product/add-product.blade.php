                      ...
                      <div class="tab-pane show active p-0 border-0" id="main-info" role="tabpanel" aria-labelledby="account" tabindex="0">
                          ...
                          <div class="row gy-3">
                              <div class="col-xl-12">
                                  ...
                                  <input type="text" class="form-control" name="name" id="product-name" placeholder="Name">
                              </div>
                              <div class="col-xl-6">
                                  <label for="product-price" class="form-label">Price</label>
                                  <input type="text" class="form-control" name="price" id="product-price" placeholder="Cost">
                              </div>
                              <div class="col-xl-6">
                                  <label for="product-actual-price" class="form-label">Actual Price</label>
                                  <input type="text" class="form-control" name="actual_price" id="product-actual-price" placeholder="Cost">
                              </div>
                              <div class="col-xl-6">
                              ...
                              <div class="col-xl-6">
                                  ...
                                  <input type="text" class="form-control" name="discount" id="product-discount" placeholder="Discount in %">
                              </div>
                              ...
                              <div class="col-xl-6">
                                ...
                                <input type="text" class="form-control" name="brands" id="product-brand" placeholder="Product Brands">
                              </div>
                              <div class="col-xl-6">
